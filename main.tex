...
\begin{figure}
  \begin{subfigure}{.1\linewidth}
    \includegraphics[width=.1\linewidth]{mode_1_training.png}\hfill
  \end{subfigure}
  \begin{subfigure}{.9\linewidth}
    \includegraphics[width=.4\linewidth]{W_l_eigv_2.eps}\hfill
    \includegraphics[width=.5\linewidth]{W_l_eigv_3.eps}
    \caption{}
