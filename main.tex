...
The first step in our work has been to compare the new physics-inspired EMF training algorithm to the PCD algorithm classically used to train RBMs, where inspection of the samples generated by the model has shown how the PCD training algorithm is slightly preferable.

 Tracking the weights distribution, whose variance has been interpreted as an inverse effective temperature, we have been able to observe how the EMF training 

To better understand how the RBM generative model works we have analyzed its learning dynamics. This has been done considering two learning algorithms: 
