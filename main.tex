...
\textsc{\Large International Master Program in Physics of Complex Systems}\\[0.5cm] % Major heading such as course name
...
\HRule \\[0.4cm]
{ \huge \bfseries Learning Dynamics of Restricted Boltzmann Machines}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
\emph{Author:}\\
Giancarlo \textsc{Fissore} % Your name
\end{flushleft}
\end{minipage}
~
\begin{minipage}{0.4\textwidth}
...
\emph{Supervisors:} \\ 
Cyril \textsc{Furtlehner}, INRIA (Paris)\\ % Supervisor's Name
Aur\'elien \textsc{Decelle}, 
Laboratoire de Recherche en Informatique (Paris)
\end{flushright}
\end{minipage}\\[2cm]
...
{\large October 2017}\\[2cm] % Date, change the \today to a set date if you want to be precise

%----------------------------------------------------------------------------------------
%	LOGO SECTION
%----------------------------------------------------------------------------------------

\includegraphics[width=0.4 \linewidth]{polito.png}\\ [1cm] % Include a department/university logo - this will require the graphicx package
