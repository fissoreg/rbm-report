...
\begin{figure}
  \begin{subfigure}{.3\linewidth}
    \includegraphics[width=1\linewidth]{mode_1_training.png}
    \caption{bias from training}
  \end{subfigure}
  \begin{subfigure}{.6\linewidth}
    \includegraphics[width=.3\linewidth]{W_l_eigv_2.eps}
    \includegraphics[width=.3\linewidth]{W_l_eigv_3.eps}
    \caption{modes}
