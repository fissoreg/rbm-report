...
The dataset we used is the MNIST database \cite{mnist}, a set of \(70000\) handwritten digits whose samples consist in \(28 \times 28\) pixels centered and size-normalized images. The first \(60000\) samples are used for training the RBM while the remaining \(10000\) samples constitute the test set, that is used to validate the training and monitoring for overfitting. Examples of the MNIST samples are shown in fig. \ref{fig:mnist}.
...
The weights distribution after training is shown in fig. \ref{fig:w_distr}. For both PCD and EMF the initial gaussian distribution is shrinked to a more peaked distribution around zero, showing the equivalence of the two methods from this point of view. In the EMF framework this legitimates the weak-couplings expansion and shows how the learning procedure determines an increase in the effective temperature \eqref{eq:t_eff}. In fig. \ref{fig:features}, instead, the hidden features generated by the RBM are shown. Each consists in the activation pattern of the visible layer driven by a single hidden unit, whose ensemble corresponds to the strokes by which the samples generated by the RBM are composed \cite{monasson}. [comment].

The most significant comparison between the two methods is given by looking at the samples generated by the trained models, shown in fig. \ref{fig:samples}. Both methods generate good models of the training data, but we can see that for EMF some samples are not resembling real digits. This is not surprising if we take into account the fact that the TAP free energy \eqref{f_tap} employed in EMF encodes also the metastable states of the corresponding physical system.
...
\begin{figure}
  ...
  \begin{subfigure}{\linewidth}
    \includegraphics[width=.05\linewidth]{W_l_eigv_2.eps}
    \includegraphics[width=.05\linewidth]{W_l_eigv_3.eps}
    \includegraphics[width=.05\linewidth]{W_l_eigv_4.eps}
    \includegraphics[width=.05\linewidth]{W_l_eigv_5.eps}
    \includegraphics[width=.05\linewidth]{W_l_eigv_6.eps}
    \includegraphics[width=.05\linewidth]{W_l_eigv_7.eps}
    \includegraphics[width=.05\linewidth]{W_l_eigv_8.eps}
    \includegraphics[width=.05\linewidth]{W_l_eigv_9.eps}
    \includegraphics[width=.05\linewidth]{W_l_eigv_10.eps}
    \caption{}
    \label{fig:modes_tr}
  \end{subfigure}\par
  \begin{subfigure}{\linewidth}
    \includegraphics[width=.05\linewidth]{X_l_eigv_2.eps}
    \includegraphics[width=.05\linewidth]{X_l_eigv_3.eps}
    \includegraphics[width=.05\linewidth]{X_l_eigv_4.eps}
    \includegraphics[width=.05\linewidth]{X_l_eigv_5.eps}
    \includegraphics[width=.05\linewidth]{X_l_eigv_6.eps}
    \includegraphics[width=.05\linewidth]{X_l_eigv_7.eps}
    \includegraphics[width=.05\linewidth]{X_l_eigv_8.eps}
    \includegraphics[width=.05\linewidth]{X_l_eigv_9.eps}
    \includegraphics[width=.05\linewidth]{X_l_eigv_10.eps}
    \caption{}
